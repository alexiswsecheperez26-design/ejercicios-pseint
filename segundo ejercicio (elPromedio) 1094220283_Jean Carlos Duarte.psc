Algoritmo elPromedio
	// Materia Nº1, definir codigo (N#=nota,M#=materia)
	...
	//tomar datos o asignar variables (notas de la materia Nº1)
	...
	//tomar datos o asignar variables (notas de la materia Nº2)
	...
	//tomar datos o asignar variables (notas de la materia Nº3)
